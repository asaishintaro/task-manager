...
// SVGアイコンの内容（icon-generator.htmlから取得）
...
console.log('SVGアイコンファイルを作成しました: public/icon.svg');
console.log('次に、以下のコマンドでPNGファイルを生成してください：');
console.log('');
console.log('# ImageMagickを使用する場合:');
console.log('magick convert -background transparent -size 192x192 public/icon.svg public/icon-192.png');
console.log('magick convert -background transparent -size 512x512 public/icon.svg public/icon-512.png');
console.log('');
console.log('# または、オンラインコンバーターを使用:');
console.log('1. https://convertio.co/svg-png/ にアクセス');
console.log('2. public/icon.svg をアップロード');
console.log('3. サイズを192x192と512x512に設定してダウンロード');